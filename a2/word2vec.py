...
def negSamplingLossAndGradient(
    ...
    k_term = np.dot((delta_1msig_neg.reshape(1,counts_k.shape[0])),counts_k*k_stack)###gai
...
def skipgram(currentCenterWord, windowSize, outsideWords, word2Ind,
    ...
    for i in range(len(outsideWords)):
        ...
        loss1,gradCenterVecs1,gradOutsideVectors1 = word2vecLossAndGradient(centerWordVec,outsideWordIdx,outsideVectors,dataset)
        loss+=loss1
        gradCenterVecs[word2Ind[currentCenterWord]] += gradCenterVecs1.reshape((centerWordVectors.shape[1],))
