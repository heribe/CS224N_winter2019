...
class Highway(nn.Module):
    ...
    def __init__(self,e_word):
        ...
        self.linear1 = nn.Linear(e_word,e_word,bias=True)
        self.linear2 = nn.Linear(e_word,e_word,bias=True)
        self.relu = nn.ReLU()
        self.sig = nn.Sigmoid()
    ...
    def forward(self,x_conv_out):
        """
        @param x_conv_out (Tensor): shape of input tensor [batch_size,e_word]
        @return x_emb(Tensor): shape [batch_size, e_word]
        """
